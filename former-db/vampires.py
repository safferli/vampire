...
vamps = [
    ...
    (None, None, "Niklaus", None, None, "Ordo Dracul", None, None),
    ...
    (None, None, "Mara", None, None, "Ordo Dracul", None, None),# Kommandantin der Eidgeschworenen der Axt
    ...
    (None, "Ratte", None, None, "Gangrel", "Invictus", None, None),# Princeps of Gangrel
    (None, None, None, "Matsumoto", None, None, "Kufukuji", None),
    ...
    (None, None, "Dr Frederik", "Austein", None, "Kartianer", None, None),
